...
public class EmployeeServiceImpl implements EmployeeService {
	...
	public Employee create(Employee employee) {
        ...
        if(employeeDepartmentHistories != null && Hibernate.isInitialized(employeeDepartmentHistories)) {
            if(!employeeDepartmentHistories.isEmpty()) {
                for(EmployeeDepartmentHistory _employeeDepartmentHistory : employeeDepartmentHistories) {
        ...
        if(employeePayHistories != null && Hibernate.isInitialized(employeePayHistories)) {
            if(!employeePayHistories.isEmpty()) {
                for(EmployeePayHistory _employeePayHistory : employeePayHistories) {
        ...
        if(jobCandidates != null && Hibernate.isInitialized(jobCandidates)) {
            if(!jobCandidates.isEmpty()) {
                for(JobCandidate _jobCandidate : jobCandidates) {
